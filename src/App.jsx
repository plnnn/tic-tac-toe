...
import { bestMove as alphaBetaBestMove } from './AlphaBeta';
import { bestMove as monteCarloBestMove } from './MonteCarlo';
import './App.css';
    ...
    const handleClick = (index) => {
        ...
        if (gameMode.startsWith('ai') && !calculateWinner(newBoard)) {
            setTimeout(() => {
                ...
                else if (gameMode === 'ai_alpha_beta') aiMove = alphaBetaBestMove(newBoard);
                else if (gameMode === 'ai_monte_carlo') aiMove = monteCarloBestMove(newBoard);
